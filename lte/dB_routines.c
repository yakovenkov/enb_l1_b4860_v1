...
int8_t dB_table[256] __attribute__((section(".shared_data_ddr0_cacheable"), aligned(16))) = {
  0,
  3,
  5,
  6,
...
int16_t dB_table_times10[256] __attribute__((section(".shared_data_ddr0_cacheable"), aligned(16))) = {
  0,
  30,
  47,
  60,
